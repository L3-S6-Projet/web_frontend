    ...
    render() {
        ...
        const lastModif = this.state.modif.map((onemodif, index) =>
            <ListItem secondary="Nom" key={index}>  {onemodif.modificationType} {onemodif.occupancy.subjectName} pour
                les {onemodif.occupancy.className} </ListItem>
        );
                ...
                <Grid item xs container direction="row" spacing={6}>
                    <Grid item xs={9}>
                        <Grid item xs container direction="row" spacing={6}>
                            ...
                            <Grid item xs={8}>
                                <Paper>
                                    <div id='title-progress'>Dernières modifications</div>
                                    <ul>{lastModif}</ul>
                                </Paper>
                            </Grid>
                            <Grid item xs={4}>
                                ...
                                <Grid item container direction="column" spacing={6}>
                                    <Grid item container direction="row" spacing={6}>
                                        ...
                                        <Grid item xs={12}>
                                            <Paper>
                                                <div id='title-progress'>Contact</div>
                                                <ul>{contacts}</ul>
                                            </Paper>
                                        </Grid>
                                    </Grid>
                    ...
                    <Grid item xs={3}>
                        <Paper>
                            <div id='title-progress'>Liens</div>
                            <ul>{links}</ul>
                        </Paper>
                    </Grid>
                </Grid>
