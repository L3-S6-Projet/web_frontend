...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Scolendar.Rank = factory(root.Scolendar.ApiClient);
  }
  ...
  /**
   * Returns a <code>Rank</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/Rank} The enum <code>Rank</code> value.
   */
