...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SuccessfulLoginResponseUser', function() {
      beforeEach(function() {
        instance = new Scolendar.SuccessfulLoginResponseUser();
      });

      it('should create an instance of SuccessfulLoginResponseUser', function() {
        // TODO: update the code to test SuccessfulLoginResponseUser
        expect(instance).to.be.a(Scolendar.SuccessfulLoginResponseUser);
      });
