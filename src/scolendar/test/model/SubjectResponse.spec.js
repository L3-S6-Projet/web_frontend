...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubjectResponse', function() {
      beforeEach(function() {
        instance = new Scolendar.SubjectResponse();
      });

      it('should create an instance of SubjectResponse', function() {
        // TODO: update the code to test SubjectResponse
        expect(instance).to.be.a(Scolendar.SubjectResponse);
      });
