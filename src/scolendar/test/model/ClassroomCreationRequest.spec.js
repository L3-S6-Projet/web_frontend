...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClassroomCreationRequest', function() {
      beforeEach(function() {
        instance = new Scolendar.ClassroomCreationRequest();
      });

      it('should create an instance of ClassroomCreationRequest', function() {
        // TODO: update the code to test ClassroomCreationRequest
        expect(instance).to.be.a(Scolendar.ClassroomCreationRequest);
      });
