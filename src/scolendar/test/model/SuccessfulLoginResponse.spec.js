...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SuccessfulLoginResponse', function() {
      beforeEach(function() {
        instance = new Scolendar.SuccessfulLoginResponse();
      });

      it('should create an instance of SuccessfulLoginResponse', function() {
        // TODO: update the code to test SuccessfulLoginResponse
        expect(instance).to.be.a(Scolendar.SuccessfulLoginResponse);
      });
