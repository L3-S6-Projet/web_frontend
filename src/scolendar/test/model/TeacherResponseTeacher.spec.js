...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeacherResponseTeacher', function() {
      beforeEach(function() {
        instance = new Scolendar.TeacherResponseTeacher();
      });

      it('should create an instance of TeacherResponseTeacher', function() {
        // TODO: update the code to test TeacherResponseTeacher
        expect(instance).to.be.a(Scolendar.TeacherResponseTeacher);
      });
      ...
      it('should have the property totalService (base name: "total_service")', function() {
        // TODO: update the code to test the property totalService
        expect(instance).to.have.property('totalService');
        // expect(instance.totalService).to.be(expectedValueLiteral);
      });
