...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ICALFeed', function() {
      beforeEach(function() {
        instance = new Scolendar.ICALFeed();
      });

      it('should create an instance of ICALFeed', function() {
        // TODO: update the code to test ICALFeed
        expect(instance).to.be.a(Scolendar.ICALFeed);
      });
