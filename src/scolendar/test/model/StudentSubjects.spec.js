...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StudentSubjects', function() {
      beforeEach(function() {
        instance = new Scolendar.StudentSubjects();
      });

      it('should create an instance of StudentSubjects', function() {
        // TODO: update the code to test StudentSubjects
        expect(instance).to.be.a(Scolendar.StudentSubjects);
      });
