...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubjectListResponseSubjects', function() {
      beforeEach(function() {
        instance = new Scolendar.SubjectListResponseSubjects();
      });

      it('should create an instance of SubjectListResponseSubjects', function() {
        // TODO: update the code to test SubjectListResponseSubjects
        expect(instance).to.be.a(Scolendar.SubjectListResponseSubjects);
      });
