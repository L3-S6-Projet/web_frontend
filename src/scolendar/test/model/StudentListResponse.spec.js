...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StudentListResponse', function() {
      beforeEach(function() {
        instance = new Scolendar.StudentListResponse();
      });

      it('should create an instance of StudentListResponse', function() {
        // TODO: update the code to test StudentListResponse
        expect(instance).to.be.a(Scolendar.StudentListResponse);
      });
