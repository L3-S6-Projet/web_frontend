...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeacherListResponseTeachers', function() {
      beforeEach(function() {
        instance = new Scolendar.TeacherListResponseTeachers();
      });

      it('should create an instance of TeacherListResponseTeachers', function() {
        // TODO: update the code to test TeacherListResponseTeachers
        expect(instance).to.be.a(Scolendar.TeacherListResponseTeachers);
      });
