...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClassWithId', function() {
      beforeEach(function() {
        instance = new Scolendar.ClassWithId();
      });

      it('should create an instance of ClassWithId', function() {
        // TODO: update the code to test ClassWithId
        expect(instance).to.be.a(Scolendar.ClassWithId);
      });
