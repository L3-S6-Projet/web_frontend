...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProfileRecentModifications', function() {
      beforeEach(function() {
        instance = new Scolendar.ProfileRecentModifications();
      });

      it('should create an instance of ProfileRecentModifications', function() {
        // TODO: update the code to test ProfileRecentModifications
        expect(instance).to.be.a(Scolendar.ProfileRecentModifications);
      });
