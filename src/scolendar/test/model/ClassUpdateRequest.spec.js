...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClassUpdateRequest', function() {
      beforeEach(function() {
        instance = new Scolendar.ClassUpdateRequest();
      });

      it('should create an instance of ClassUpdateRequest', function() {
        // TODO: update the code to test ClassUpdateRequest
        expect(instance).to.be.a(Scolendar.ClassUpdateRequest);
      });
