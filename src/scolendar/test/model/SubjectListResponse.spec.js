...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubjectListResponse', function() {
      beforeEach(function() {
        instance = new Scolendar.SubjectListResponse();
      });

      it('should create an instance of SubjectListResponse', function() {
        // TODO: update the code to test SubjectListResponse
        expect(instance).to.be.a(Scolendar.SubjectListResponse);
      });
