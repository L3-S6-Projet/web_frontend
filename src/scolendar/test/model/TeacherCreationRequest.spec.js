...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeacherCreationRequest', function() {
      beforeEach(function() {
        instance = new Scolendar.TeacherCreationRequest();
      });

      it('should create an instance of TeacherCreationRequest', function() {
        // TODO: update the code to test TeacherCreationRequest
        expect(instance).to.be.a(Scolendar.TeacherCreationRequest);
      });
