...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClassesList', function() {
      beforeEach(function() {
        instance = new Scolendar.ClassesList();
      });

      it('should create an instance of ClassesList', function() {
        // TODO: update the code to test ClassesList
        expect(instance).to.be.a(Scolendar.ClassesList);
      });
      ...
      it('should have the property classes (base name: "classes")', function() {
        // TODO: update the code to test the property classes
        expect(instance).to.have.property('classes');
        // expect(instance.classes).to.be(expectedValueLiteral);
      });
