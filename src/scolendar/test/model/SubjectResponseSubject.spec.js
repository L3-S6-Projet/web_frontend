...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubjectResponseSubject', function() {
      beforeEach(function() {
        instance = new Scolendar.SubjectResponseSubject();
      });

      it('should create an instance of SubjectResponseSubject', function() {
        // TODO: update the code to test SubjectResponseSubject
        expect(instance).to.be.a(Scolendar.SubjectResponseSubject);
      });
